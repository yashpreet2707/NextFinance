    ...
    return (
        <form className='space-y-6' onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='space-y-2'>
                    ...
                    <Select onValueChange={(value) => setValue("accountId", value)} defaultValue={getValues('accountId')}>
                        ...
                        <SelectContent>
                            ...
                            <CreateAccountDrawer>
                                <Button variant='ghost' className='w-[240%] sm:w-[430%] md:w-[252%] mx-auto select-none items-center text-sm outline-none'>Create Account</Button>
                            </CreateAccountDrawer>
                        </SelectContent>
                    </Select>
                    {errors.accountId && (
            ...
            <div className='space-y-2'>
                ...
                <Popover>
                    ...
                    <PopoverContent className='w-auto p-0' align='start'>
                        <Calendar mode='single' selected={date} onSelect={(date) => setValue('date', date)} disabled={(date) => date > new Date() || date < new Date('1900-0-01')} initialFocus />
                    </PopoverContent>
                </Popover>
                {errors.date && (
            ...
            <div className='space-y-2'>
                ...
                <Input type='text' step="0.01" placeholder="Enter Description" {...register('description')} />
                {errors.description && (
